  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      List<dynamic> filteredMonthData =
          chartOrderController.chartDeep.where((data) {
      ...
      return Container(
        ...
        padding:
            const EdgeInsets.only(top: 36.0, left: 10, right: 10, bottom: 10),
        child: Column(
